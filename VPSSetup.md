...
*sudo apt-get install build-essential (if required. For C compiler)
node
...
Setup redis as shown here : http://redis.io/topics/quickstart
...
Python pip / virtualenv / uwsgi / django
